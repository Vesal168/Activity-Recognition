...
def graph_activity(activity, color, title):
    ...
    plot_graph(ax0, activity['timestamp'].values, activity['xAxis'], 'X', color)
    plot_graph(ax1, activity['timestamp'].values, activity['yAxis'], 'Y', color)
    plot_graph(ax2, activity['timestamp'].values, activity['zAxis'], 'Z', color)
    plt.suptitle(title)
...
def graph_magnitude(activity, color):
    ...
    plot_graph(axs, activity['timestamp'], activity['magnitude'], "Result acceleration vector", color)
...
def graph_divided_signal(activity, color):
    ...
    plot_graph(ax0, activity['timestamp'], activity['xAxis'], 'X', color)
    plot_graph(ax1, activity['timestamp'], activity['yAxis'], 'Y', color)
    plot_graph(ax2, activity['timestamp'], activity['zAxis'], 'Z', color)
    plot_graph(ax3, activity['timestamp'], activity['magnitude'], 'Result acceleration vector', color)
